FILE HANDLE   DCOM90 / NAME='H:\HIST\1990s\DCOM90\dcom90.dat' / LRECL = 80.
...
VALUE LABELS   FRAM
                  ...
                  3 'COUNTY'
                  4 'UNKNOWN'.
VARIABLE LABELS     DCM 'MONTH OF COMMITMENT'.
...
VALUE LABELS   SENTYPE
                  ...
                  6 'SPLIT'
                  9 'FINE'.
VARIABLE LABELS     ORGORG 'COURT FROM WHICH COMMITTED'.
COMPUTE        ORGCT=ORGORG.
VARIABLE LABELS     ORGCT 'COUNTY OF COURT FROM WHICH COMMITTED'.
RECODE         ORGCT
               (15 THRU 22,35,88=13)
                  (23,68 THRU 71=11)
                           (24,25=1)
...
COMPUTE OFFD = OFF1.
COMPUTE OFFO = OFF1.
VARIABLE LABELS     OFFP  'PERSON OFFENSES'
              /OFFS  'SEX OFFENSES'
...
SAVE OUTFILE = "H:\HIST\1990s\DCOM90\dcom90.sav".
